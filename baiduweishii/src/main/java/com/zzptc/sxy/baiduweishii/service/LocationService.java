package com.zzptc.sxy.baiduweishii.service;
...
public class LocationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            List<Contant> contacts = dbManager.selector(Contant.class).findAll();


            for(Contant c:contacts){

                String sms_one = "[百度手机卫士警报]" + c.getHelpMessage() + "。我的位置：" + addressDescription;
